...
ART_DIRECTION_PLANS = [
    {
        ...
        "material_language": "translucent jacket, sporty inner layer, small straps, glass reflection, polished floor, soft hair shine",
    ...
    },
    {
        ...
        "material_language": "wood grain, ceramic cup, paper book pages, sheer curtain, soft fabric, small glass highlights",
    ...
    },
    {
        ...
        "graphic_concept": "bookstore cafe corner; vertical shelves, a round table, cup, open book, and warm window light build a quiet readable scene",
    ...
    },
    {
        ...
        "outfit_direction": "transparent summer jacket over a sporty camisole, fresh and polished",
        "material_language": "transparent jacket, white summer layer, glass cup, stickers, small bag charm",
    ...
    },
    {
        ...
        "spatial_structure": "pale fairy-tale room or cloud space, pillows, petals, book pages, ribbons, and small toys floating lightly",
...
ACTION_STYLES = [
    ...
    },
    {
        ...
        "body_silhouette": "a small dessert, drink, bouquet, book, or toy sits nearby as scene detail; hands stay simple and do not need to hold the object",

...
CHARACTER_PROFILES = {
    ...
    "丹": {
        "official_core": "浅粉短发，空气感碎刘海，粉紫眼睛，安静、透明、未来感的少女。",
    ...
    "席德": {
        ...
        "thumbnail_strategy": "银灰发、蓝紫电光和机械细节必须清楚，避免普通校园少女化。",
        "interaction_rule": "允许站在机械光源前、抱着小型机械件；避免复杂机械手和多手结构。",
...
ART_DIRECTION_PLANS = [
    ...
    {
        "name": "aquarium_blue_light",
        "graphic_concept": "水族馆蓝光幻想，梦境感但构图简洁。",
        "spatial_structure": "巨大水槽、少量鱼影、玻璃反光。",
        "visual_device": "蓝色水光在背景流动，角色轮廓清楚。",
        "body_silhouette": "站姿或轻靠玻璃，手掌自然靠近身体，不贴镜头。",
        "outfit_direction": "soft stage outfit, simple silhouette, no complex props",
        "material_language": "水光、玻璃、柔软发丝。",
        "color_strategy": "蓝色环境中保留角色主色，不让人物被染成同色。",
        "lighting_behavior": "柔和水波光，眼睛高光稳定。",
        "tags": ["aquarium", "blue", "dream"],
    },
    {

...
ART_DIRECTION_PLANS = [
    ...
    },
    {
        ...
        "visual_device": "thin curtain, small jewelry tray, flower stem in a vase, glass cup, folded cloth, and soft indoor floor reflection create minimal narrative detail",

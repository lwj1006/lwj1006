...
def prompt_for_art_direction(
    ...
    lines = [
        ...
        "Pose and emotion discipline: execute the one selected football-supporter culture pose and its specified facial emotion as one coherent moment. Preserve its exact arm position, prop interaction, body tension, mouth expression, and eye energy instead of replacing it with a blank face, generic calm gaze, mechanical raised hand, polite clapping pose, or small fist beside the shoulder.",

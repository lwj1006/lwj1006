...
YANG_MI_ORIGINAL_COLOR_THEMES = [
    ...
    "soft-cream fantasy hanfu robe with champagne-gold embroidery, layered collar, wide sleeves, and structured embroidered belt, elegant xianxia styling",
    ...
    "champagne-ivory qipao-inspired gown with a high mandarin collar, leaf embroidery, and restrained crystal beading, modern Chinese couture styling",
...
YANG_MI_COLOR_FREE_THEMES = [
    ...
    "fantasy hanfu robe with restrained metallic embroidery, layered collar, wide sleeves, and structured embroidered belt, elegant xianxia styling",
    ...
    "qipao-inspired gown with a high mandarin collar, leaf embroidery, and restrained crystal beading, modern Chinese couture styling",

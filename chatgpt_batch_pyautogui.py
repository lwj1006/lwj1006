...
CLOTHING_DISPLAY_LABELS = {
    ...
    "ribbed cropped cardigan set, matching ribbed shorts, sports bralette, minimal Korean streetwear": "针织开衫两件套",
    ...
    "vintage floral corset top, structured bustier top, garden portrait fashion": "复古碎花胸衣",

...
from prompt_options import GROUP_SHOT_CONCEPTS, HORIZONTAL_POSES, POSES, SINGLE_SHOT_CONCEPTS
...
CHARACTER_PROFILES = {
    ...
    "丹": {
        "identity": (
            "丹，不属于妄想天使阵容，是安静温柔且略淡漠的未来圣女感少女。"
            "视觉必须锁定为浅粉色短发少女：空气感厚刘海，不对称刘海，两侧包脸短发，发尾外翻；"
            "柔软羽毛感短层次发型，浅粉色头发渐变，粉紫色眼睛。"
            "可以保留银白细头环、蓝银色星形发卡、耳侧未来科技模块、轻机械耳机结构。"
        ),
        "palette": (
            "气质：安静、温柔、淡漠、轻科幻圣女感，带一点神性和透明感。"
            "服装可用白、浅蓝、雾粉、米白、浅灰、淡金属色、低饱和黑。"
            "禁止长发化、成熟化、普通粉发甜妹化、妄想天使成员化、厚重机械装甲化。"
        ),
    },
}

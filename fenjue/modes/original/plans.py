...
CHARACTER_PROFILES = {
    ...
    "橘福福": {
        "official_core": "golden-orange short hair, yellow-green eyes, small tiger ears, red-white festive accessory, energetic human girl.",
        "identity_tokens": ["golden-orange short hair", "green or yellow-green eyes", "small tiger ears", "red festive accessory", "human girl, not animalized"],
        "viewer_relationship": "moving forward or caught mid-motion with a smile, warm image mood.",
        "thumbnail_strategy": "golden-orange hair, yellow-green eyes, tiger ears, and red-white accessory must stay stable; do not turn her into a tiger beast-person.",
        "interaction_rule": "running, side attention, festive motion are fine; avoid realistic tiger face, animal muzzle, animal legs, claws, or full animal transformation.",
    ...
    "简": {
        "official_core": "short layered black bob with gray highlights, pointed elf ears with multiple silver piercings, turquoise-green eyes, long dark-crimson rear hair extension.",
        "identity_tokens": ["short layered black bob with gray highlights", "pointed elf ears with multiple silver piercings", "turquoise-green eyes", "long dark-crimson rear hair extension"],
        "viewer_relationship": "playful confident presence with a natural front, three-quarter, or side gaze; keep the eyes, ears, hair silhouette readable.",
        "thumbnail_strategy": "black-gray bob, turquoise-green eyes, pierced elf ears, crimson rear hair extension must stay clear; outfit and undercover gear may vary.",
    ...
    "洛茜": {
        "official_core": "thick warm golden-blonde hair with layered bangs and large curled side locks, bright amber-gold eyes, two tall blonde fox ears with pale inner fur.",
        "identity_tokens": ["thick warm golden-blonde hair", "layered bangs and large curled side locks", "bright amber-gold eyes", "two tall blonde fox ears"],
        "viewer_relationship": "bright, curious, and energetic, with an alert friendly gaze.",
        "thumbnail_strategy": "the blonde curls, tall fox ears, amber eyes must stay clear.",
        "interaction_rule": "Keep a human anime face and limbs, exactly two fox ears. The red hood, weapons, drawing props, and exact clothing are optional.",
        "color_anchor": "golden blonde, amber, warm cream, restrained red",
    },
    "庄方宜": {
        "official_core": "extremely long deep black-green hair with a straight blunt fringe, vivid teal inner strands and broad red face-framing underlayers, luminous yellow-green eyes with red eyeliner, long pointed ears, paired silver square temple clips, two very large high angular black-crimson branching horns.",
        "identity_tokens": ["extremely long deep black-green hair", "straight blunt fringe", "teal inner strands and broad red face layers", "yellow-green eyes with red eyeliner", "long pointed ears", "paired silver square temple clips", "two very large black-crimson branching horns"],
        "viewer_relationship": "calm, warm, and quietly confident.",
        "thumbnail_strategy": "the black-green hair, red-teal face layers, huge horns, yellow-green eyes, pointed ears must remain distinct.",
        "interaction_rule": "Never shrink the horns into clips or replace them with mammal ears. Uniform, mechanical sleeves, weapons, and effects are optional.",
    ...
    "陈千语": {
        "official_core": "short tousled black crown hair with two very long high-back twin tails, warm red-orange eyes, two narrow black dragon horns edged in red and teal.",
        "identity_tokens": ["short tousled black crown hair", "two very long high-back black twin tails", "warm red-orange eyes", "two narrow black dragon horns edged red and teal"],
        "viewer_relationship": "open, cheerful, and energetic, with a bright confident smile.",
        "thumbnail_strategy": "the short black crown, long twin tails, colored horns, red-orange eyes must remain visible.",
        "interaction_rule": "Keep compact youthful proportions, exactly two horns. Uniform, sword, pistol, and combat equipment are optional.",
    ...
    "忘归人": {
        ...
        "identity_tokens": ["very long dark chestnut hair with reddish lower lengths", "layered swept bangs and long face-framing locks", "green-gold eyes", "two tall fox ears with pale interiors", "gold floral hair ornaments and red tassels", "slender feminine human-shaped torso and limbs"],
        ...
        "interaction_rule": "Keep the long brown hair distinct from the background portrait, which is not another person to generate.",
        "color_anchor": "dark chestnut hair, green-gold eyes, gold floral ornaments and red tassels",
    },
    "符玄": {

...
CHARACTER_PROFILES = {
    ...
    "今汐": {
        "official_core": "silvery-white hair with straight eyebrow-length blunt bangs, rounded jaw-length side locks, and two extremely long low side tails that fade to pale aqua and end in narrow feather-like points. Each side tail is anchored behind the ear by a dark bronze openwork ornament and a large translucent pale-aqua ribbon bow; her eyes are pale gray with a muted rose tint.",
        "identity_tokens": ["silvery-white hair", "straight eyebrow-length blunt bangs", "rounded jaw-length side locks", "two extremely long low side tails with pale-aqua feather-like ends", "paired dark bronze openwork hair ornaments", "paired translucent pale-aqua ribbon bows", "pale gray-rose eyes"],
        ...
        "interaction_rule": "preserve exactly two low side tails and do not turn them into loose hair, a single ponytail, or short twin tails. Dragons, weapons, and ceremonial clothing are reference-only scene elements, never fixed identity.",
    ...
    "坎特蕾拉": {
        "official_core": "very long flowing lavender hair with a smooth crown, a heavy curved fringe sweeping across one side of the forehead, curled cheek-length side locks, violet-pink eyes with cyan highlights, a narrow white ruffled headband, and a layered blue-violet flower ornament at the side of the head.",
        "identity_tokens": ["very long flowing lavender hair", "heavy curved side-swept fringe", "curled cheek-length side locks", "violet-pink eyes with cyan highlights", "narrow white ruffled headband", "layered blue-violet side flower ornament"],
    ...
    "秧秧": {
        "official_core": "long layered midnight-blue hair with a short rounded crown, straight separated bangs, and broad feather-shaped side and rear locks that transition through white to luminous pale cyan and deep cobalt tips. She has clear cyan-blue eyes, a slim vertical pale-blue forehead mark, small gold bird-shaped ornaments at one temple, and a restrained red tassel accent behind the same side.",
        "identity_tokens": ["long layered midnight-blue hair", "short rounded crown and separated bangs", "broad white-to-cyan feather-shaped hair locks", "deep cobalt hair tips", "clear cyan-blue eyes", "slim vertical pale-blue forehead mark", "small gold bird-shaped temple ornaments", "restrained red side tassel"],
        "viewer_relationship": "calm, considerate, and quietly resolute.",
        "thumbnail_strategy": "the dark crown, white-cyan feather-layered hair silhouette, blue eyes, forehead mark, gold temple ornament, and red tassel must remain readable.",
        "interaction_rule": "the pale feather-shaped structures are part of the layered hairstyle, not detached wings. The blue bird companion, floating feathers, weapons, and exact black-blue outfit are reference-only and must not be forced.",
    ...
    "长离": {
        "official_core": "a layered coral-pink short crown and sweeping side fringe over a contrasting extremely long pearl-white rear ponytail, with two slim white braided face locks, warm amber-gold eyes, and dark bronze flower-shaped hair ornaments linked by fine loops.",
        "identity_tokens": ["layered coral-pink short crown hair", "sweeping coral-pink side fringe", "extremely long pearl-white rear ponytail", "two slim white braided face locks", "warm amber-gold eyes", "dark bronze flower-shaped hair ornaments with fine loops", "elegant mature silhouette"],
        ...
        "interaction_rule": "preserve the two-tone construction: short coral-pink crown hair over one extremely long white rear ponytail. Never turn all of the hair uniformly white or uniformly red. Flame effects, weapons, and the exact black-red costume are optional.",

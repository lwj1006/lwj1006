...
CHARACTER_PROFILES = {
    ...
    "莫宁": {
        "official_core": "pale silver-blue hair with a heavy fringe covering one eye and extremely long rear lengths, one visible red eye, two small triangular clips, long triangular earrings, and a separate floating dark crystal halo.",
        "identity_tokens": ["pale silver-blue hair", "heavy one-eye fringe", "extremely long rear hair", "one visible red eye", "two triangular hair clips", "long triangular earrings", "separate floating dark crystal halo"],
        "viewer_relationship": "cool, analytical, and quietly uncanny.",
        "thumbnail_strategy": "the one-eye fringe, red eye, long silver-blue hair, triangular details, and floating halo must remain clear.",
        "interaction_rule": "The dark halo floats separately above the head and must never become a hat or solid headband. Holograms, tools, and laboratory clothing are optional.",

...
CHARACTER_PROFILES = {
    ...
    "今汐": {
        "official_core": "silvery-white hair with straight eyebrow-length blunt bangs, rounded jaw-length side locks, and two extremely long low side tails that fade to pale aqua and end in narrow feather-like points. Each side tail is anchored behind the ear by a dark bronze openwork ornament and a large translucent pale-aqua ribbon bow; her eyes are pale gray with a muted rose tint. Her Tacet Mark is centered on the mid-back.",
        "identity_tokens": ["silvery-white hair", "straight eyebrow-length blunt bangs", "rounded jaw-length side locks", "two extremely long low side tails with pale-aqua feather-like ends", "paired dark bronze openwork hair ornaments", "paired translucent pale-aqua ribbon bows", "pale gray-rose eyes", "mid-back Tacet Mark when naturally visible"],
        "viewer_relationship": "serene, dignified, and gently attentive.",
        "thumbnail_strategy": "the blunt white fringe, rounded short side locks, paired bronze ornaments, aqua bows, and two long low tails must remain readable.",
        "interaction_rule": "preserve exactly two low side tails and do not turn them into loose hair, a single ponytail, or short twin tails. Preserve the mid-back Tacet Mark only when that skin is naturally visible; never alter or open the outfit merely to display it. Dragons, weapons, and ceremonial clothing are reference-only scene elements, never fixed identity.",
        "color_anchor": "silvery white, pale aqua, soft teal, restrained gold",
    },
    "千咲": {
        "official_core": "very long glossy black hair with blunt bangs, vivid red eyes, a red ribbon tied into the side or rear hair, and a Tacet Mark on the right upper arm.",
        "identity_tokens": ["very long glossy black hair", "blunt bangs", "vivid red eyes", "red side or rear hair ribbon", "right-upper-arm Tacet Mark when naturally visible"],
        ...
        "interaction_rule": "preserve a slim youthful impression and preserve the right-upper-arm Tacet Mark whenever that area is naturally visible; never modify sleeves solely to reveal it. The giant red-black weapon and school outfit are optional reference styling only.",
        "color_anchor": "glossy black, vivid red, clean white",
    },
    "卡提希娅": {
        "official_core": "very long golden-blonde hair, long pointed elf ears, clear blue eyes, a blue-silver branch-like crown ornament, blue teardrop earrings, and her distinct Tacet Mark centered on the forehead beneath the crown ornament.",
        "identity_tokens": ["very long golden-blonde hair", "long pointed elf ears", "clear blue eyes", "blue-silver branch-like crown ornament", "blue teardrop earrings", "center-forehead Tacet Mark"],
        "viewer_relationship": "graceful, bright, and composed.",
        "thumbnail_strategy": "blonde hair, pointed ears, blue eyes, the branching crown ornament, and the forehead Tacet Mark must remain clear.",
        "interaction_rule": "keep the elf ears and center-forehead Tacet Mark visible and hands simple; the Tacet Mark is a skin marking beneath the crown, not an extra jewel. Weapons and the exact ceremonial outfit are not fixed identity.",
        "color_anchor": "golden blonde, sky blue, silver, soft white",
    },
    "坎特蕾拉": {
        "official_core": "very long flowing lavender hair with a smooth crown, a heavy curved fringe sweeping across one side of the forehead, curled cheek-length side locks, violet-pink eyes with cyan highlights, a narrow white ruffled headband, and a layered blue-violet flower ornament at the side of the head. Her Tacet Mark is on the tongue and is normally hidden when her mouth is closed.",
        "identity_tokens": ["very long flowing lavender hair", "heavy curved side-swept fringe", "curled cheek-length side locks", "violet-pink eyes with cyan highlights", "narrow white ruffled headband", "layered blue-violet side flower ornament", "tongue Tacet Mark only when the tongue is naturally visible"],
        "viewer_relationship": "elegant, mysterious, and knowingly calm.",
        "thumbnail_strategy": "the lavender hair mass, curved fringe, violet-cyan eyes, white ruffled headband, and blue-violet side flower must remain readable.",
        "interaction_rule": "the large violet parasol in every source image is a removable handheld prop, never a hat or identity trait. Do not generate any umbrella or parasol unless the selected photoset template explicitly requires one. Do not force an open mouth, protruding tongue, or unusual expression to display the tongue Tacet Mark; preserve it only when the chosen expression naturally reveals the tongue. Underwater effects, jellyfish motifs, and the exact dress are also optional reference styling.",
        "color_anchor": "lavender, deep violet, icy blue, pearl white",
    },
    "守岸人": {
        "official_core": "short wavy pale aqua-blue hair, clear blue eyes, a large white headpiece with luminous blue butterfly-wing or feather-like ornaments, and a crystal-like resonance trace centered on the chest that glows pale blue during ability use. As an Echo-energy construct, this chest trace is not a conventional Resonator Tacet Mark.",
        "identity_tokens": ["short wavy pale aqua-blue hair", "clear blue eyes", "large white headpiece", "luminous blue butterfly-wing or feather ornaments", "crystal-like center-chest resonance trace"],
        ...
        "interaction_rule": "preserve a light ethereal presence and the crystal-like chest trace when naturally visible; it may glow pale blue during ability use. Do not mislabel the string-like wave scars on her limbs as Tacet Marks, and never alter the outfit merely to expose the chest trace. Cosmic butterflies and the exact white-blue dress are optional scene styling.",
        "color_anchor": "pale aqua, luminous blue, clean white, midnight blue",
    },
    "尤诺": {
        "official_core": "deep navy hair in two large high ponytails fading to pale blue, short face-framing layers, iridescent blue-gold eyes, gold laurel-like head ornaments, and a Tacet Mark on the instep of the left foot.",
        "identity_tokens": ["deep navy high twin ponytails", "pale blue gradient hair ends", "short face-framing layers", "iridescent blue-gold eyes", "gold laurel-like head ornaments", "left-instep Tacet Mark when naturally visible"],
        ...
        "interaction_rule": "the circular blue-gold device and exact outfit are optional; do not replace the twin ponytails with loose long hair. Preserve the left-instep Tacet Mark only in compositions that naturally show that area; never remove footwear or change the pose solely to display it.",
        "color_anchor": "deep navy, pale blue, luminous gold, black",
    },
    "洛瑟菈": {
        "official_core": "extremely long indigo-violet hair fading to pale lavender, heavy sweeping bangs covering one eye, one visible violet eye, a broad dark star-map disc hat, large double-hoop earrings, and a Tacet Mark on the outer right calf.",
        "identity_tokens": ["extremely long indigo-violet hair", "pale lavender hair ends", "one-eye sweeping fringe", "visible violet eye", "broad star-map disc hat", "large double-hoop earrings", "outer-right-calf Tacet Mark when naturally visible"],
        ...
        "interaction_rule": "preserve the asymmetric face framing and the outer-right-calf Tacet Mark whenever that area is naturally visible; never shorten or open clothing merely to reveal it. Bags, gloves, and the exact fashion outfit are optional.",
        "color_anchor": "indigo, violet, pale lavender, charcoal black",
    },
    "爱弥斯": {
        "official_core": "extremely long pink hair in a high ponytail, luminous cyan feather-like hair ornaments and highlights, amber-gold eyes, and a chest-centered Tacet Mark whose pattern has changed and become unstable in her current electronic-ghost state.",
        "identity_tokens": ["extremely long pink high ponytail", "luminous cyan feather-like hair ornament", "cyan hair highlights", "amber-gold eyes", "changed unstable chest-centered Tacet Mark when naturally visible"],
        ...
        "interaction_rule": "use lively but simple movement and preserve the current chest-centered Tacet Mark when that area is naturally visible; never alter the neckline solely to show it. Mechanical companions, weapons, and the exact outfit are optional.",
        "color_anchor": "bright pink, luminous cyan, amber gold, clean black",
    },
    "琳奈": {
        "official_core": "sandy ash-blonde hair fading to mint-turquoise, looped side and rear hair gathered with black ribbons, blue-violet eyes, a small skull hair clip, and a Tacet Mark on the back of the left thigh.",
        "identity_tokens": ["sandy ash-blonde hair", "mint-turquoise gradient ends", "looped side and rear hair", "black hair ribbons", "blue-violet eyes", "small skull hair clip", "back-of-left-thigh Tacet Mark when naturally visible"],
        ...
        "interaction_rule": "bubble gum, motorcycle, jacket, and exact streetwear are optional; never flatten the looped hairstyle into a plain bob. Preserve the back-of-left-thigh Tacet Mark only when the composition and clothing naturally reveal it; never change clothing or pose solely to display it.",
        "color_anchor": "ash blonde, mint turquoise, black, blue violet",
    },
    "秧秧": {
        "official_core": "long layered midnight-blue hair with a short rounded crown, straight separated bangs, and broad feather-shaped side and rear locks that transition through white to luminous pale cyan and deep cobalt tips. She has clear cyan-blue eyes, a slim vertical pale-blue Tacet Mark centered on the forehead, small gold bird-shaped ornaments at one temple, and a restrained red tassel accent behind the same side.",
        "identity_tokens": ["long layered midnight-blue hair", "short rounded crown and separated bangs", "broad white-to-cyan feather-shaped hair locks", "deep cobalt hair tips", "clear cyan-blue eyes", "slim vertical pale-blue center-forehead Tacet Mark", "small gold bird-shaped temple ornaments", "restrained red side tassel"],
        "viewer_relationship": "calm, considerate, and quietly resolute.",
        "thumbnail_strategy": "the dark crown, white-cyan feather-layered hair silhouette, blue eyes, center-forehead Tacet Mark, gold temple ornament, and red tassel must remain readable.",
        "interaction_rule": "the slim pale-blue vertical mark is her skin-level Tacet Mark centered on the forehead, not a jewel or pasted ornament. The pale feather-shaped structures are part of the layered hairstyle, not detached wings. The blue bird companion, floating feathers, weapons, and exact black-blue outfit are reference-only and must not be forced.",
        "color_anchor": "deep navy, pale blue, soft gold, restrained red",
    },
    "绯雪": {
        "official_core": "very long silver-white hair worn loose down the back beneath one large high rounded topknot bun, with thick straight blunt bangs, two long curled face-framing locks, vivid red eyes, and paired dark-red ribbon ornaments at the sides of the bun.",
        "identity_tokens": ["very long loose silver-white rear hair", "large high rounded topknot bun", "thick straight blunt bangs", "two long curled face-framing locks", "vivid red eyes", "paired dark-red side ribbons"],
        "viewer_relationship": "reserved, elegant, and sharply focused.",
        "thumbnail_strategy": "the white topknot over long loose hair, blunt fringe, red eyes, and paired red ribbons must remain clear.",
        "interaction_rule": "keep one topknot with long loose rear hair; do not convert it into a ponytail. Ice weapons and the exact red-white costume are optional reference styling.",
        "color_anchor": "silver white, vivid red, cool blue, charcoal black",
    },
    "莫宁": {
        "official_core": "pale silver-blue hair with a short heavy fringe covering one eye and extremely long rear lengths, one visible red eye, two small triangular hair clips, a floating dark crystal halo, long triangular earrings, and a Tacet Mark on the outer left thigh.",
        "identity_tokens": ["pale silver-blue hair", "one-eye heavy fringe", "extremely long rear hair", "visible red eye", "two triangular hair clips", "floating dark crystal halo", "long triangular earrings", "outer-left-thigh Tacet Mark when naturally visible"],
        ...
        "interaction_rule": "the halo floats above the head and must not become a hat; holograms, laboratory clothing, and props are optional. Preserve the outer-left-thigh Tacet Mark only when that exact area is naturally visible; never invent its appearance on a covered surface or change clothing or pose merely to reveal it.",
        "color_anchor": "silver blue, dark crystal black, red, restrained cyan",
    },
    "菲比": {
        "official_core": "very long wavy blonde hair with blunt bangs and side curls, violet eyes, a small blue cross hair clip, an oversized white wide-brim hat with a blue feather ornament, and a Tacet Mark high on the left thigh.",
        "identity_tokens": ["very long wavy blonde hair", "blunt bangs and side curls", "violet eyes", "small blue cross hair clip", "oversized white wide-brim hat", "blue feather ornament", "upper-left-thigh Tacet Mark when naturally visible"],
        ...
        "interaction_rule": "preserve the wide-brim hat unless a composition makes it impossible; staff and exact white-blue clothing are optional. Preserve the upper-left-thigh Tacet Mark only when it is naturally readable through or above the canonical legwear; never alter the clothing or pose solely to display it.",
    ...
    "达妮娅": {
        "official_core": "very long pastel pink hair fading to pale blue-lavender with curled ribbon-like ends, a side braid and curled side knot, pale blue-violet eyes, a blue gem with a white wing-like ornament, black lace-like head trim, and a chest-centered Tacet Mark.",
        "identity_tokens": ["very long pastel pink hair", "pale blue-lavender gradient ends", "curled ribbon-like hair ends", "side braid and curled side knot", "pale blue-violet eyes", "blue gem and white wing ornament", "black lace-like head trim", "chest-centered Tacet Mark when naturally visible"],
        ...
        "interaction_rule": "preserve the soft elaborate hair structure and the chest-centered Tacet Mark whenever the canonical outfit naturally shows it; never lower or open a neckline merely to reveal it. Teddy pendants, weapons, and exact stage clothing are optional.",
        "color_anchor": "pastel pink, pale blue, lavender, black lace, pearl white",
    },
    "长离": {
        "official_core": "a layered coral-pink short crown and sweeping side fringe over a contrasting extremely long pearl-white rear ponytail, with two slim white braided face locks, warm amber-gold eyes, dark bronze flower-shaped hair ornaments linked by fine loops, and a Tacet Mark below the chest on the upper abdomen.",
        "identity_tokens": ["layered coral-pink short crown hair", "sweeping coral-pink side fringe", "extremely long pearl-white rear ponytail", "two slim white braided face locks", "warm amber-gold eyes", "dark bronze flower-shaped hair ornaments with fine loops", "elegant mature silhouette", "upper-abdomen Tacet Mark when naturally visible"],
        "viewer_relationship": "composed, intelligent, and subtly formidable.",
        "thumbnail_strategy": "the coral-pink short crown, long white rear ponytail, paired white braids, amber eyes, and bronze flower ornaments must remain readable.",
        "interaction_rule": "preserve the two-tone construction: short coral-pink crown hair over one extremely long white rear ponytail. Never turn all of the hair uniformly white or uniformly red. Preserve the upper-abdomen Tacet Mark only when a safe canonical outfit naturally reveals it; never crop, lower, or open clothing merely to display it. Flame effects, weapons, and the exact black-red costume are optional.",
        "color_anchor": "pearl white, coral red, charcoal black, warm gold",
    },
    "诀": {
        "official_core": "silver-white hair with pale mint-cyan underlayers, a short rounded jaw-length bob with a heavy curved fringe, and several extremely long high-back streaming locks. Two tall upright black feather tufts with white inner blades rise from the crown, while separate broad horizontal white-gray feather crests extend from both sides of the head. She has vivid violet-to-cyan eyes, fine red markings beneath the outer corners, and one vertical red diamond-like forehead mark.",
        "identity_tokens": ["silver-white hair with pale mint-cyan underlayers", "short rounded jaw-length bob and heavy curved fringe", "extremely long high-back streaming locks", "two tall upright black crown feather tufts with white inner blades", "separate broad horizontal white-gray side feather crests", "vivid violet-to-cyan eyes", "fine red outer-eye markings", "vertical red diamond-like forehead mark"],
        "viewer_relationship": "focused and self-possessed, with a direct clear gaze and controlled expression.",
        "thumbnail_strategy": "the short silver-mint bob, distinct vertical crown feathers, separate horizontal side feathers, violet-cyan eyes, and central red forehead mark must remain unmistakable.",
        "interaction_rule": "keep the upright crown tufts and horizontal side crests as two distinct fixed Liberi feather structures, never mammal ears, horns, a hat, or one merged feather crown. Clothing, tactical equipment, bow, and energy effects are reference-only.",
    ...
    "庄方宜": {
        "official_core": "extremely long deep black-green hair with a straight eyebrow-level blunt fringe, vivid teal inner strands, and broad red underlayer locks framing both sides of the face. She has luminous yellow-green eyes with strong red eyeliner, long pointed ears, paired silver square temple clips, two large angular black-to-crimson branching qilin horns rising high above the crown, and one thick dark-teal scaled tail with red fin-like tips.",
        "identity_tokens": ["extremely long deep black-green hair", "straight eyebrow-level blunt fringe", "vivid teal inner strands and broad red face-framing underlayers", "luminous yellow-green eyes with red eyeliner", "long pointed ears", "paired silver square temple clips", "two large high black-crimson angular branching qilin horns", "one thick dark-teal scaled tail with red fin-like tips"],
        "viewer_relationship": "calm, warm, and quietly confident, with a composed natural smile.",
        "thumbnail_strategy": "the black-green hair, red-teal face layers, very large black-crimson horns, yellow-green eyes, pointed ears, and scaled tail must remain distinct.",
        "interaction_rule": "the paired horns are large, tall, angular, and physically attached to the crown; never shrink them into short clips or replace them with mammal ears. Preserve exactly one continuous scaled tail. Uniform, mechanical sleeves, sword, and digital effects are reference-only.",
        "color_anchor": "forest green, deep teal, crimson red, green gold, soft white",
    },
    "艾尔黛拉": {
        "official_core": "a warm chestnut-brown short layered crown bob with curled cheek locks and one enormous high rear-side ponytail built from a thick looped section, a slim braid, and a long hanging wavy length. She has vivid rose-magenta eyes, two medium gray ridged goat horns curving outward beside the crown, dark pointed Caprinae ears behind them, and paired red and blue triangular clips at one temple.",
        "identity_tokens": ["warm chestnut short layered crown bob", "curled cheek locks", "one enormous high rear-side ponytail with thick loop, slim braid, and long wavy length", "vivid rose-magenta eyes", "two medium gray ridged outward-curving goat horns", "dark pointed Caprinae ears", "paired red and blue triangular temple clips"],
        "viewer_relationship": "gentle, upbeat, and approachable, with a soft lively smile.",
        "thumbnail_strategy": "the chestnut crown bob, huge looped side ponytail, rose eyes, curved gray horns, dark ears, and red-blue clips must remain readable.",
        "interaction_rule": "keep compact youthful proportions and preserve the horns and dark ears as separate structures. Do not shrink the ponytail into a small tie or flatten it into loose hair. The purple dress, white coat, stockings, medical styling, and pink bird or fluffy companions are reference-only.",
        "color_anchor": "warm chestnut, rose magenta, soft gray, small red and blue accents",
    },
    "佩丽卡": {
        "official_core": "silver-white hair gathered into one enormous fountain-like ponytail rising very high from the back of the crown, with several black-gray outer strands, fine black ahoge arcs, thick softly separated bangs, and multiple long curled face-framing locks. She has clear ice-blue eyes and two large sharp wing-like gray-white Liberi feather crests extending horizontally from the sides of the head with darker outer tips.",
        "identity_tokens": ["enormous very-high fountain-like silver-white ponytail", "black-gray outer ponytail strands and fine black ahoge arcs", "thick softly separated bangs", "multiple long curled face-framing locks", "clear ice-blue eyes", "two large sharp horizontal gray-white Liberi side feather crests with dark tips"],
        "viewer_relationship": "intelligent, attentive, and quietly friendly, with clear open eyes.",
        "thumbnail_strategy": "the towering fountain ponytail, ice-blue eyes, curled side locks, and large dark-tipped horizontal feather crests must stay stable.",
        "interaction_rule": "the side crests are large fixed Liberi feather structures, not small clips, cat ears, or loose hair. Preserve one towering rear ponytail. The white technical dress, jacket, gloves, tools, and machinery are reference-only.",

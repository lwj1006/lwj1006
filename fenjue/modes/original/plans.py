...
CHARACTER_PROFILES = {
    ...
    "丹": {
        "official_core": "saturated rose-pink layered face-framing hair with a rounded shoulder-length silhouette, long sweeping asymmetrical bangs, vivid magenta-violet faceted eyes, two small silver star hair clips, a large blue-violet folded ribbon structure at the rear, and a permanent paired wing system that shifts between pale feathered wings and dark indigo feather-mechanical wings across canonical forms.",
        "identity_tokens": ["saturated rose-pink layered hair", "rounded shoulder-length face-framing silhouette", "long sweeping asymmetrical bangs", "vivid magenta-violet faceted eyes", "two small silver star hair clips", "large blue-violet rear ribbon structure", "paired feather or feather-mechanical wings"],
        ...
        "thumbnail_strategy": "the rose-pink layered hair silhouette, sweeping fringe, luminous magenta-violet eyes, silver star clips, blue-violet rear ribbon, and the visible root or silhouette of both wings must remain recognizable.",
        "interaction_rule": "Treat the paired wings as permanent character anatomy, not clothing or a scene prop. Preserve two wings with coherent shoulder-back attachment whenever framing allows. Their canonical state may be pale white-lilac layered feathers or dark indigo feather-mechanical arrays; never combine both states into extra wings, and never replace them with tiny decorative shoulder ornaments.",
    ...
    "千咲": {
        "official_core": "very long glossy black hair with a heavy straight blunt fringe, vivid red eyes, and a restrained red ribbon tied into the side or rear hair.",
        "identity_tokens": ["very long glossy black hair", "heavy straight blunt fringe", "vivid red eyes", "restrained red side or rear hair ribbon"],
        "viewer_relationship": "quietly confident, youthful, and slightly intense.",
        "thumbnail_strategy": "the dense black hair mass, blunt fringe, red eyes, and single red ribbon must stay unmistakable.",
        "interaction_rule": "Keep the hairstyle long and straight with one restrained ribbon. The giant red-black weapon, school styling, and reference clothing are optional only.",
    ...
    "琳奈": {
        "official_core": "sandy ash-blonde hair fading to mint-turquoise, looped side and rear sections tied with black ribbons, blue-violet eyes, and one small skull-shaped hair clip.",
        "identity_tokens": ["sandy ash-blonde hair", "mint-turquoise gradient ends", "looped side and rear hair sections", "black hair ribbons", "blue-violet eyes", "small skull hair clip"],
        "viewer_relationship": "casual, playful, and effortlessly cool.",
        "thumbnail_strategy": "the ash-to-mint gradient, looped silhouette, blue-violet eyes, black ribbons, and skull clip must stay readable.",
        "interaction_rule": "Never flatten the looped hairstyle into a plain bob. Bubble gum, motorcycle, jacket, and streetwear are optional reference styling.",
    ...
    "绯雪": {
        "official_core": "very long loose silver-white rear hair beneath one large high rounded topknot, thick straight blunt bangs, two long curled face locks, vivid red eyes, and paired dark-red ribbon ornaments beside the bun.",
        "identity_tokens": ["very long loose silver-white rear hair", "one large high rounded topknot", "thick straight blunt bangs", "two long curled face locks", "vivid red eyes", "paired dark-red bun ribbons"],
        "viewer_relationship": "reserved, elegant, and sharply focused.",
        "thumbnail_strategy": "the white topknot above long loose hair, blunt fringe, red eyes, and paired red ribbons must remain clear.",
        "interaction_rule": "Keep one topknot with long loose rear hair; never convert it into a high ponytail. Ice weapons and red-white combat clothing are optional reference styling.",
